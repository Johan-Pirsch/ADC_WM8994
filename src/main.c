...
static void MX_SAI1_Init(void)
{
	 ...
	 /* USER CODE BEGIN SAI1_Init 1 */
	  ...
	  /*CONFIGURE SAI BLOCK_SLOT */
		hsai_BlockA1.SlotInit.FirstBitOffset = 0;
		hsai_BlockA1.SlotInit.SlotSize = SAI_SLOTSIZE_DATASIZE;
		hsai_BlockA1.SlotInit.SlotNumber = 4;
		hsai_BlockA1.SlotInit.SlotActive = SAI_SLOTACTIVE_0 |SAI_SLOTACTIVE_1 | SAI_SLOTACTIVE_2| SAI_SLOTACTIVE_3; //AUDIO STREAM IN SPEAKER ONLY SAI1 SLOT AND SAI SLOT 3 MUST BE ACTIVATED
	 ...
	 hsai_BlockB1.SlotInit.SlotActive = SAI_SLOTACTIVE_0 |SAI_SLOTACTIVE_1 | SAI_SLOTACTIVE_2| SAI_SLOTACTIVE_3; //AUDIO STREAM IN SPEAKER ONLY SAI1 SLOT AND SAI SLOT 3 MUST BE ACTIVATED
